...
// after selecting one, then that selection is made into a string for the Post model value of "group_topic"
...
// if the comment's attribute of "group_topic" matches, then it's set to display = block. Otherwise, it's set to display = none
